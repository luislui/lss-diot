    ...
    >
      <div className="max-h-[90vh] w-full max-w-2xl overflow-hidden rounded-lg border border-neutral-300 bg-white shadow-xl dark:border-neutral-600 dark:bg-neutral-800">
        <div className="flex items-center justify-between border-b border-neutral-200 px-4 py-3 dark:border-neutral-600">
          <h2 id="help-modal-title" className="text-lg font-semibold text-neutral-900 dark:text-neutral-100">
        ...
        <div className="max-h-[70vh] overflow-y-auto p-4 text-sm text-neutral-700 dark:text-neutral-300">
          <section className="mb-4">
            <h3 className="mb-2 font-semibold text-neutral-900 dark:text-neutral-100">¿Qué hace esta aplicación?</h3>
            <p>
          ...
          <section className="mb-4">
            <h3 className="mb-2 font-semibold text-neutral-900 dark:text-neutral-100">Pasos para usar la aplicación</h3>
            <ol className="list-decimal space-y-2 pl-5">
              ...
              <li>
                <strong>Descargar TXT</strong> cuando todo sea correcto. Sube el archivo <code className="rounded bg-neutral-200 px-1 dark:bg-neutral-600">diot.txt</code> según indique el SAT.
              </li>
            </ol>
          </section>

          <section className="mb-4">
            <h3 className="mb-2 font-semibold text-neutral-900 dark:text-neutral-100">Botones de la barra de herramientas</h3>
            <ul className="space-y-1.5">
              ...
              <li><strong>Pegar desde portapapeles</strong> — Pega datos copiados (p. ej. desde Excel). <strong>Obligatorio:</strong> la primera fila debe ser encabezados; se abrirá un cuadro para mapear columnas. Atajo: <kbd className="rounded border border-neutral-400 bg-neutral-100 px-1.5 py-0.5 text-xs dark:bg-neutral-600">Ctrl+V</kbd> (o <kbd className="rounded border border-neutral-400 bg-neutral-100 px-1.5 py-0.5 text-xs dark:bg-neutral-600">Cmd+V</kbd> en Mac).</li>
          ...
          <section className="mb-4">
            <h3 className="mb-2 font-semibold text-neutral-900 dark:text-neutral-100">Validación y campos condicionales</h3>
            <p className="mb-2">
          ...
          <section>
            <h3 className="mb-2 font-semibold text-neutral-900 dark:text-neutral-100">Tabla</h3>
            <p>
        ...
        <div className="border-t border-neutral-200 px-4 py-3 dark:border-neutral-600">
          <button
            type="button"
            onClick={onClose}
