...
export const schema2025: DiotColumn[] = [
  ...
  { id: 'pais_residencia_fiscal', label: 'País residencia fiscal', type: 'text', required: true, requiredWhen: 'Obligatorio si es extranjero' },
  { id: 'lugar_jurisdiccion', label: 'Lugar de jurisdicción fiscal', type: 'text', required: true, requiredWhen: 'Obligatorio si es extranjero' },
  { id: 'v1', label: 'Base norte', type: 'number', requiredWhen: 'Valor total de actos o actividades pagadas en la región fronteriza norte' },
  { id: 'v2', label: 'Devol. norte', type: 'number', requiredWhen: 'Devoluciones, descuentos y bonificaciones en la región fronteriza norte' },
  { id: 'v3', label: 'Base sur', type: 'number', requiredWhen: 'Valor total de actos o actividades pagadas en la región fronteriza sur' },
  { id: 'v4', label: 'Devol. sur', type: 'number', requiredWhen: 'Devoluciones, descuentos y bonificaciones en la región fronteriza sur' },
  { id: 'v5', label: 'Base 16%', type: 'number', requiredWhen: 'Valor total de actos o actividades pagadas a la tasa del 16% de IVA' },
  { id: 'v6', label: 'Devol. 16%', type: 'number', requiredWhen: 'Devoluciones, descuentos y bonificaciones a la tasa del 16% de IVA' },
  { id: 'v7', label: 'Base Imp. Tan. 16%', type: 'number', requiredWhen: 'Valor total de actos o actividades pagados en la importación por aduana de bienes tangibles a la tasa del 16% de IVA' },
  ...
  { id: 'v9', label: 'Base Imp. Intan. 16%', type: 'number', requiredWhen: 'Valor total de actos o actividades pagadas en la importación de bienes intangibles y servicios a la tasa del 16% de IVA' },
